...
def main():
    ...
    parser.add_argument("-o", "--output", default="configModuleAP_ANPS.toml", help="Base output filename")
    ...
    sel_above_ap = array()
    sel_above_ap.append(["module", "risetime", "risetime", [0.01]])
    ...
    crosscorr_light.add("CorrFraction", 0.3)
    # crosscorr_light.add("OnlineCutBottom", 0.85)
    crosscorr_light.add("CorrCut", 0.9)
